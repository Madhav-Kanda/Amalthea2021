...
module.exports.live = [
	{ name: "Electronica", image: "../images/events/Electronica.png", registration: "/eventRegistration?event=Electronica", rulebook: "../rulebooks/Electronica.pdf", about:"Amalthea'21 provides the perfect opportunity for people who have no resistance to achieving their full potential. Electronica seeks to provide a platform for all electrical enthusiasts to brush up on and showcase their technical skills, hours of lab practise, and compete against the country's brightest minds." },

    { name: "Cryptorush", image: "../images/events/CryptoRush.png", registration: "/eventRegistration?event=Cryptorush", rulebook: "../rulebooks/CryptoRush.pdf", about:"CryptoRush is back to provide you with the greatest virtual trading experience. Conducted on Roostoo, it is a cryptocurrency exchange competition that allows novices to learn about crypto investment without risking their money and experienced traders to practice trading techniques using real-time market data." },
